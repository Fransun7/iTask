      ...
      {tasks.map((task) => (
        ...
        >
          ...
          <div className="w-[75%] p-2">
            <input className="w-full h-2/5  p-2 focus:outline-none bg-stone-200 dark:bg-primary-dark placeholder:opacity-60 dark:placeholder:opacity-30 rounded-sm"
              type="text"
            ...
            />
            <p className="text-sm text-stone-600">{new Date(task.createdAt).toLocaleString()}</p>
          </div>

          {/*Right side of the card*/}
          <div className="w-[20%] pt-6 flex gap-8 justify-center">
            <img className="w-8 h-8" src={Delete} alt="delete-icon"
